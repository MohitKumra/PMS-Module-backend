...
export async function list(req: Request, res: Response, next: NextFunction) {
  try {
    const filters: NoteListFilters = {
      ...
      sortField: typeof req.query.sortField === 'string' ? req.query.sortField as NoteListFilters['sortField'] : undefined,
      sortOrder: typeof req.query.sortOrder === 'string' ? req.query.sortOrder as NoteListFilters['sortOrder'] : undefined,
